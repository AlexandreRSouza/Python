...
if metas < quant_vendas:
    print('Batems a meta de vendas de Iphone, vendemos {} unidades.' .format(quant_vendas))
...
if metas < quant_vendas:
    print('Batemos a meta de vendas de Iphone, vendemos {} unidades.' .format(quant_vendas))
else:
    print('Infelizmente não batemos a meta, vendemos {} unidades. A meta era de {} unidades' .format(quant_vendas, metas))    