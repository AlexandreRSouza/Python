...
if vendas_funci > meta_vendas and vendas_loja > meta_loja:
    bonus = 0.03 * vendas_funci
    print('Ganhou um bônus de {}' .format(bonus))
else:
...
if nota_funci >= meta_nota or (vendas_funci > meta_vendas and vendas_loja > meta_loja):
        bonus = 0.03 * vendas_funci
        print('Ganhou um bônus de {}.'.format(bonus))
else:
        print('Não ganhou o bônus!')