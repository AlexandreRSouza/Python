...
if vendas_funcionario1 >= meta:
    ...
    print('Ganhou bônus de R$ {}.' .format(bonus))
else:
    print('Funcioário 01 Não atingeu a meta e não ganhou bônus.')        
if vendas_funcionario2 >= meta:
    bonus = 0.10 * vendas_funcionario2
    print('Ganhou bônus de R$ {}.' .format(bonus))
else:
    print('Funcioário 02 Não atingeu a meta e não ganhou bônus.')      
if vendas_funcionario3 >= meta:
    bonus =0.10 * vendas_funcionario3
    print('Ganhou bônus de R$ {}.' .format(bonus))
else:
   print('Funcioário 03 Não atingeu a meta e não ganhou bônus.')  
